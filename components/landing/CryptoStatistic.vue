<template>
  <div
    class="w-full lg:w-1/3 mt-6 lg:mt-0 overflow-hidden space-y-6"
    v-bind="$attrs"
  >
          ...
          <table class="min-w-full">
            <thead>
              <tr>
                ...
                <th
                  class="hidden sm:block text-left text-sm font-medium text-gray-500"
                >
                  Chart
                </th>
              </tr>
              ...
              >
                <td class="py-4 whitespace-nowrap">
                  <div class="flex items-center space-x-2">
                    <!-- <img
                      :src="`~/assets/img/crypto-icon/${data.logo}`"
                      alt=""
                    /> -->
                    <nuxt-img :src="`/img/crypto-icon/${data.logo}`" />
                    <span>{{ data.name }}</span>
                  </div>
                </td>
                <td class="py-4 whitespace-nowrap">
